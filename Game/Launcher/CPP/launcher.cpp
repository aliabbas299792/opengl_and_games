...
launcher::launcher(networking *networkObject, sf::RenderWindow* mainWindow, sf::Clock* globalClock) : networkBit(networkObject), window(mainWindow), notifClock(globalClock) {
