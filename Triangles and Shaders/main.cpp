...
int main(){
	...
	//1st param is the index of the attribute in the vertexShader GLSL
	...
	//5th param is the 'stride', which is the byte offset between consecutive verticies in the array, assuming they are tightly packed (directly consecutive)
